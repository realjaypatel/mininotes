...
static BSON_INLINE uint16_t __bson_uint16_swap_slow(uint16_t v) /* IN */
{
...
static BSON_INLINE uint32_t __bson_uint32_swap_slow(uint32_t v) /* IN */
{
...
static BSON_INLINE uint64_t __bson_uint64_swap_slow(uint64_t v) /* IN */
{
...
static BSON_INLINE double __bson_double_swap_slow(double v) /* IN */
{
  uint64_t uv;
