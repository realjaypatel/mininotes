...
static void set_memory_error(void) { PyErr_NoMemory(); }
...
int pymongo_buffer_get_position(buffer_t buffer) { return buffer->position; }

char* pymongo_buffer_get_buffer(buffer_t buffer) { return buffer->buffer; }

void pymongo_buffer_update_position(buffer_t buffer,
