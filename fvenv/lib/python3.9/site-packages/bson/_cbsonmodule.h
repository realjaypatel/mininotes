...
#define INT2STRING(buffer, i)                       \
  _snprintf_s((buffer), _scprintf("%lld", (i)) + 1, \
              _scprintf("%lld", (i)) + 1, "%lld", (i))
#define STRCAT(dest, n, src) strcat_s((dest), (n), (src))
#else
#define INT2STRING(buffer, i) \
  _snprintf((buffer), _scprintf("%lld", (i)) + 1, "%lld", (i))
...
#define _cbson_buffer_write_bytes_PROTO \
  (buffer_t buffer, const char* data, int size)

#define _cbson_write_dict_INDEX 1
#define _cbson_write_dict_RETURN int
#define _cbson_write_dict_PROTO                              \
  (PyObject * self, buffer_t buffer, PyObject * dict,        \
...
#define _cbson_write_pair_PROTO                                               \
  (PyObject * self, buffer_t buffer, const char* name, int name_length,       \
   PyObject* value, unsigned char check_keys, const codec_options_t* options, \
   unsigned char allow_id)

#define _cbson_decode_and_write_pair_INDEX 3
#define _cbson_decode_and_write_pair_RETURN int
#define _cbson_decode_and_write_pair_PROTO                             \
  (PyObject * self, buffer_t buffer, PyObject * key, PyObject * value, \
   unsigned char check_keys, const codec_options_t* options,           \
   unsigned char top_level)

#define _cbson_convert_codec_options_INDEX 4
#define _cbson_convert_codec_options_RETURN int
#define _cbson_convert_codec_options_PROTO \
  (PyObject * self, PyObject * options_obj, codec_options_t * options)
...
#define _cbson_buffer_write_int32_at_position_PROTO \
  (buffer_t buffer, int position, int32_t data)
...
static _cbson_buffer_write_bytes_RETURN buffer_write_bytes
    _cbson_buffer_write_bytes_PROTO;
...
static _cbson_decode_and_write_pair_RETURN decode_and_write_pair
    _cbson_decode_and_write_pair_PROTO;

static _cbson_convert_codec_options_RETURN convert_codec_options
    _cbson_convert_codec_options_PROTO;

static _cbson_destroy_codec_options_RETURN destroy_codec_options
    _cbson_destroy_codec_options_PROTO;

static _cbson_buffer_write_double_RETURN buffer_write_double
    _cbson_buffer_write_double_PROTO;

static _cbson_buffer_write_int32_RETURN buffer_write_int32
    _cbson_buffer_write_int32_PROTO;

static _cbson_buffer_write_int64_RETURN buffer_write_int64
    _cbson_buffer_write_int64_PROTO;

static _cbson_buffer_write_int32_at_position_RETURN
    buffer_write_int32_at_position _cbson_buffer_write_int32_at_position_PROTO;

static _cbson_downcast_and_check_RETURN _downcast_and_check
    _cbson_downcast_and_check_PROTO;
...
#define buffer_write_bytes                                                \
  (*(_cbson_buffer_write_bytes_RETURN(*) _cbson_buffer_write_bytes_PROTO) \
       _cbson_API[_cbson_buffer_write_bytes_INDEX])

#define write_dict               \
  (*(_cbson_write_dict_RETURN(*) \
         _cbson_write_dict_PROTO)_cbson_API[_cbson_write_dict_INDEX])

#define write_pair               \
  (*(_cbson_write_pair_RETURN(*) \
         _cbson_write_pair_PROTO)_cbson_API[_cbson_write_pair_INDEX])

#define decode_and_write_pair                \
  (*(_cbson_decode_and_write_pair_RETURN(*)  \
         _cbson_decode_and_write_pair_PROTO) \
       _cbson_API[_cbson_decode_and_write_pair_INDEX])

#define convert_codec_options                \
  (*(_cbson_convert_codec_options_RETURN(*)  \
         _cbson_convert_codec_options_PROTO) \
       _cbson_API[_cbson_convert_codec_options_INDEX])

#define destroy_codec_options                \
  (*(_cbson_destroy_codec_options_RETURN(*)  \
         _cbson_destroy_codec_options_PROTO) \
       _cbson_API[_cbson_destroy_codec_options_INDEX])

#define buffer_write_double                                                 \
  (*(_cbson_buffer_write_double_RETURN(*) _cbson_buffer_write_double_PROTO) \
       _cbson_API[_cbson_buffer_write_double_INDEX])

#define buffer_write_int32                                                \
  (*(_cbson_buffer_write_int32_RETURN(*) _cbson_buffer_write_int32_PROTO) \
       _cbson_API[_cbson_buffer_write_int32_INDEX])

#define buffer_write_int64                                                \
  (*(_cbson_buffer_write_int64_RETURN(*) _cbson_buffer_write_int64_PROTO) \
       _cbson_API[_cbson_buffer_write_int64_INDEX])

#define buffer_write_int32_at_position                \
  (*(_cbson_buffer_write_int32_at_position_RETURN(*)  \
         _cbson_buffer_write_int32_at_position_PROTO) \
       _cbson_API[_cbson_buffer_write_int32_at_position_INDEX])

#define _downcast_and_check                                               \
  (*(_cbson_downcast_and_check_RETURN(*) _cbson_downcast_and_check_PROTO) \
       _cbson_API[_cbson_downcast_and_check_INDEX])
